...
( 
  ...
  A_FNAME   VARCHAR(20) NOT NULL COMMENT 'THE FIRST NAME OF AUTHOR', 
  A_LNAME   VARCHAR(20) COMMENT 'THE LAST NAME OF AUTHOR', 
  ...
  A_EMAIL   VARCHAR(40) NOT NULL COMMENT 'THE EMAIL ADDRESS OF AUTHOR' 
);
...
ALTER TABLE JPN_AUTHOR 
  MODIFY A_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'UNIQUE IDENTIFIER FOR THE AUTHOR';
...
( 
  ...
  CUST_FNAME VARCHAR(20) NOT NULL COMMENT 'THE FIRST NAME OF CUSTOMER', 
  CUST_LNAME VARCHAR(20) COMMENT 'THE LAST NAME OF CUSTOMER', 
  CUST_PHONE VARCHAR(10) NOT NULL COMMENT 'THE PHONE NUMBER OF CUSTOMER', 
  CUST_EMAIL VARCHAR(40) NOT NULL COMMENT 'THE EMAIL ADDRESS OF CUSTOMER', 
...
ALTER TABLE JPN_CUSTOMER 
  MODIFY CUST_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'UNIQUE IDENTIFIER FOR CUSTOMER';
...
ALTER TABLE JPN_CUSTOMER
  ADD CONSTRAINT CK_JPN_CUSTOMER_PHONE
  CHECK (
    LENGTH(CUST_PHONE) = 10 AND
    CUST_PHONE = CAST(CUST_PHONE AS UNSIGNED)
  );
