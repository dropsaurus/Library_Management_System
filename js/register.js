document.addEventListener("DOMContentLoaded", () => {
  ...
  // Get the phone input element and error message
  ...
  if (phoneInput && phoneError) {
    ...
    phoneInput.addEventListener("input", function () {
      ...
      if (this.value.length > 0 && this.value.length !== 10) {
        ...
        this.style.borderColor = this.value.length === 10 ? "#2ecc71" : "";
      }
    });
  }
  ...
  if (roleSelect) {
    ...
    roleSelect.addEventListener("change", function () {
      ...
      if (selectedRole === "customer") {
        console.log(
          "Customer selected, showing customer fields, hiding author fields"
        );
        ...
        console.log(
          "Author selected, showing author fields, hiding customer fields"
        );
        if (customerFields) customerFields.style.display = "none";
